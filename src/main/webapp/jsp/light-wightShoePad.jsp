                ...
                <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                    ...
                    <div class="layui-tab-content" style="height: 100px;">
                        <div class="layui-tab-item layui-show">
                            <form class="layui-form editPerInfo" action="${pageContext.request.contextPath }/edit_es_pad.do" method="post"  lay-filter="example">
                        ...
                        <div class="layui-tab-item">
                            <form class="layui-form editPerInfo" action="${pageContext.request.contextPath }/edit_mm_pad.do" method="post"  lay-filter="example">
                                <div class="layui-form-item" style="margin-top: 20px;">
...
<%--                    <img id="lightfoot" class="big_img" src="../mdhtml/img/shoes3.png"--%>
<%--                         onclick="document.getElementById('light').style.display ='none' ;document.getElementById('fade').style.display='none'" />--%>
<%--                    <div id="fadefoot" class="black_overlay"></div>--%>
                </div>
    ...
    <div id="light" class="white_content">
        ...
        <div class="graphicDisplay">
            ...
            <div class="display2" onclick="window.open('${pageContext.request.contextPath }/jsp/shoepad_model.jsp')">
            </div>
...
<script>
    ...
    function forbid() {
        ...
        //处理相关逻辑
        // DoSomething();
        var url = "${pageContext.request.contextPath}/optimization_Pad";
