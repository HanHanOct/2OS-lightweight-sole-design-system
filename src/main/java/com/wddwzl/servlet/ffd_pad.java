...
public class ffd_pad extends HttpServlet {
    @Override
...
//            MWNumericArray m5 = new MWNumericArray(user.getHeelEdge());
            ...
            f2.sole_FFD(modelPath,m1,m2,m3,m4,m5,L,W,filePath);
...
//        resp.sendRedirect("/smbms/jsp/shoemidshoe_model.jsp");
        ...
        try {
            String fileName = this.getServletContext().getRealPath("userResource/"+user.getUserCode()+"/model/outPad");
