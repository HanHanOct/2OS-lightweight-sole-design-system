...
<%@ page import="com.wddwzl.pojo.User" %>
<%@ page import="com.wddwzl.util.Constants" %>
<% User user = (User)session.getAttribute(Constants.USER_SESSION);String UserCode = user.getUserCode();%>
<%--${pageContext.request.contextPath }/userResource/"+"<%=UserCode%>"+"/model/outShoemidsole-draco.gltf--%>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    function initModel() {
        ...
        loader.load("${pageContext.request.contextPath }/userResource/"+"<%=UserCode%>"+"/model/outShoemidsole-draco.gltf", function (gltf) {
    ...
    var pageForward = new function () {
        this.forward = function () {
            location.replace("${pageContext.request.contextPath }/jsp/frame.jsp");
        }
    };
