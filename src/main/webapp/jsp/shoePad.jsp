...
<head>
    ...
    <title>3D定制模型-鞋垫</title>
    <script src="../layui-v2.6.8/layui/layui.js"></script>
    <link rel="stylesheet" href="../layui-v2.6.8/layui/css/layui.css"
          media="all">
          tppabs="..\mdhtml\layui-v2.6.8\layui\css\layui.css" media="all">
    <style>
        body,
        html {
        ...
        <div class="box1">
            <div class="divleft1">
                ...
                <h4 style="line-height:1.8em;">
                    糖尿病足是糖尿病患者最严重的并发症之一。传统的糖尿病鞋在市场应用中存在较大的痛点与难点，而这其中很多问题都可结合3D打印技术来解决。
                    我们通过优化具体的填充结构，来搭建了一个完整的数字化生产体系，包括足型扫描、建模生成、结构设计、快速生产等。来帮助糖尿病患者解决足
                    应力问题，降低并发症发生几率。
                </h4>
            </div>
            <div class="divright1">
                        ...
                        <ul class="layui-nav">
                            <li class="layui-nav-item">
                                ...
                                <dl class="layui-nav-child">
                                    <dd><a href="${pageContext.request.contextPath }/jsp/Shoemidsole.jsp" target="_self">鞋中底</a></dd>
...
<%--                    style="background-color: #ffffff;"--%>
            ...
            <div class="experience">
                <button type="button" class="layui-btn layui-btn-normal layui-btn-radius"
                        onclick="window.location.href='${pageContext.request.contextPath }/forwardToPad'"
