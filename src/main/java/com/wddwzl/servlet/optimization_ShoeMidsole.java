...
public class optimization_ShoeMidsole extends HttpServlet {
    @Override
...
//        req.getRequestDispatcher("/2OS/ffd_shoe_mid_sole").include(req,resp);
//        req.getRequestDispatcher("/2OS/ffd_shoe_mid_sole").forward(req,resp);
        resp.sendRedirect("/2OS/ffd_shoe_mid_sole");
   }
